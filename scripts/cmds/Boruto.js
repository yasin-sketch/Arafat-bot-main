...
async function a(api, event, args, message) {
  ...
  try {
    ...
    const b = "you are Boruto"; // the more better content you give the  best it became
...
module.exports = {
  ...
  config: {
    ...
    name: "boruto",// add your ai name here
    ...
    longDescription: " A Ai Based On Itachi",// ai description

    category: "ai",

    guide: {

      en: "{p}cmdName [boruto]"// add guide based on your ai name
