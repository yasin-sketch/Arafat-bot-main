...
config: {
  ...
  onStart: async function ({ message, args, event, threadsData, role }) {
    ...
    if (args.length === 0) {
      ...
      createAndSendImage(message, "https://i.ibb.co/7GF0zVV/GIF-20240422-020615-598.gif", await generateHelpList(prefix)); // resize image ok if you are planning to change background image link 
  ...
  ╰━━━━━━━❖`;
        ...
        createAndSendCommandInfoImage(message, "https://i.ibb.co/7GF0zVV/GIF-20240422-020615-598.gif", response);
      }
    }
  },
};
