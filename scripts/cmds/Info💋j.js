...
module.exports = {
  ...
  onStart: async function ({ message, api, event, usersData, threadsData }) {
    ...
    const authorInsta = "https://www.instagram.com/editz_of_easir";
    const authorEmail = global.GoatBot.config.authorEmail;
    const authorfav = "anime, programming, musterbating ";
    const status = "just waiting for a perfect life partner";
