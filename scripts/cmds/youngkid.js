...
module.exports = {
  config: {
    ...
    role: 0,
    author: "𝗞𝘀𝗵𝗶𝘁𝗶𝘇",
    shortDescription: "Send a random video from a youngkid Facebook group",
    longDescription: "Send a random video link from a youngkid Facebook group",
    category: "𝗙𝗕𝗚𝗥𝗢𝗨𝗣",
    dependencies: {
      axios: "",
    },
  ...
  onStart: async function ({ api, event }) {
    try {
      ...
      const groupId = "1386387971848529";
        ...
        if (unsentVideos.length === 0) {
          ...
          videoResponse.data.on("end", async () => {
            if (fs.existsSync(filePath)) {
              ...
              await api.sendMessage(
                {
                  body: "𝗥𝗮𝗻𝗱𝗼𝗺 𝘃𝗶𝗱𝗲𝗼 𝗳𝗿𝗼𝗺 𝘆𝗼𝘂𝗻𝗴𝗸𝗶𝗱 𝗳𝗯 𝗴𝗿𝗼𝘂𝗽. 💫",
